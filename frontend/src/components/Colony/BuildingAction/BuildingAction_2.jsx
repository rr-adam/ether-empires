...
function BuildingAction_2() {
  ...
  const assignedDefenses = buildingsInfo?.[2].defenses.toString();
  ...
  const energyProdLevel = buildingsInfo?.[2]?.level.toNumber() || 0;
  ...
  if (buildingsInfo) {
    return (
      <>
        <div>
          <p><span className='font-bold'>Production rate:</span> {energyRate.toFixed(2)} Water / min</p>
...
export default BuildingAction_2;
...
function BuildingAction_3() {
  ...
  const assignedDefenses = buildingsInfo?.[3].defenses.toString();
  ...
  const energyProdLevel = buildingsInfo?.[3]?.level.toNumber() || 0;
  ...
  if (buildingsInfo) {
    return (
      <>
        <div>
          <p><span className='font-bold'>Production rate:</span> {energyRate.toFixed(2)} Ore / min</p>
...
export default BuildingAction_3;